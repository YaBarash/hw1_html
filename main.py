                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <p class="d-inline-flex gap-1">
                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#howbuy" role="button"
                               aria-expanded="false" aria-controls="howbuy">
                                Как купить?
                            </a>
                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#howdeliver" role="button"
                               aria-expanded="false" aria-controls="howdeliver">
                                Как доставить?
                            </a>
                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#whichgarantee" role="button"
                               aria-expanded="false" aria-controls="whichgarantee">
                                Какая гарантия?
                            </a>
                        </p>
                        <div class="collapse" id="howbuy">
                            <div class="card card-body">
                                Чтобы купить товар, нужно добавить понравившийся продукт в корзину и оплатить онлайн.
                            </div>
                        </div>
                        <div class="collapse" id="howdeliver">
                            <div class="card card-body">
                                Чтобы доставить товар, нужно выбрать тип доставки - курьер или почта.
                                Для доставки курьером указать адрес, для почты - индекс.
                            </div>
                        </div>
                        <div class="collapse" id="whichgarantee">
                            <div class="card card-body">
                                Гарантия на все продукты сроком 1 год.
                            </div>
                        </div>
                    </div>
                </div>
